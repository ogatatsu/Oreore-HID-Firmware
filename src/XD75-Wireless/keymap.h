...
Key keymap[] = {
  ...
  { 67, NK(_BracketLeft) },
  { 68, NK(_Quote) },
  { 69, LY({ NK(_Int3), NK(_Int1) }) },
  { 70, NK(_ArrowDown) },

  { 71, LY({ NK(_Equal), _______, NK(_F12) }) },
  { 72, NK(_BracketRight) },
  { 73, NK(_Backslash) },
  { 74, DBL(SL(1), TD({ { OSM(_Shift), OSM(_Shift) },
                        { CK(_Shift, _CapsLock), CK(_Shift, _CapsLock) } })) },
  { 75, NK(_ArrowRight) },
};
