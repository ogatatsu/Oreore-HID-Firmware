...
constexpr uint8_t GESTURE_ID_SCR = 0;
...
Key keymap[] = {
  ...
  { 7, NK(Q) },
  { 8, LY({ NK(A), _______, MS_CLK(LeftButton) }) },
  { 9, NK(Z) },
  { 10, NOP() },

  { 11, LY({ NK(_2), _______, ToH(NK(F2), 1500, BT(2)) }) },
  { 12, NK(W) },
  { 13, LY({ NK(S), _______, GoT(GESTURE_ID_SCR, MS_CLK(MiddleButton)) }) },
  { 14, NK(X) },
  { 15, NOP() },

  { 16, LY({ NK(_3), _______, ToH(NK(F3), 1500, BT(3)) }) },
  { 17, NK(E) },
  { 18, LY({ NK(D), _______, MS_CLK(RightButton) }) },
  { 19, NK(C) },
  { 20, MO(Gui) },
  ...
  { 42, NK(Y) },
  { 43, LY({ NK(H), _______, NK(Left) }) },
  { 44, NK(N) },
  { 45, LoT(2, NK(Int4)) },

  { 46, LY({ NK(_7), _______, NK(F7) }) },
  { 47, NK(U) },
  { 48, LY({ NK(J), _______, NK(Down) }) },
  { 49, NK(M) },
  ...
  { 52, NK(I) },
  { 53, LY({ NK(K), _______, NK(Up) }) },
  { 54, NK(Comma) },
  { 55, NOP() },

  { 56, LY({ NK(_9), _______, NK(F9) }) },
  { 57, NK(O) },
  { 58, LY({ NK(L), _______, NK(Right) }) },
  { 59, NK(Period) },
  { 60, NK(Up) },
...
Gesture gestureMap[] = {
  ...
  { GESTURE_ID_SCR, MOUSE_ID, 50, AngleSnap::Enable, MS_SCR(1, 0), MS_SCR(-1, 0), _______, _______ },
};
