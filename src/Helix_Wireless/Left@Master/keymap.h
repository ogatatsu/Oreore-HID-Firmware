...
Key keymap[] = {
  ...
  { 2, LY({ NK(_1), CK(Shift, _1), NK(_1) }) },
  { 3, LY({ NK(_2), CK(Shift, _2), NK(_2) }) },
  { 4, LY({ NK(_3), CK(Shift, _3), NK(_3) }) },
  ...
  { 34, LY({ NK(L), CK(Shift, LeftBracket), NK(LeftBracket) }) },
  { 35, LY({ NK(Semicolon), CK(Shift, RightBracket), NK(RightBracket) }) },
  ...
  { 43, LY({ NK(LeftBracket), CK(Shift, _9), _______ }) },
  { 44, LY({ NK(RightBracket), CK(Shift, _0), _______ }) },
  ...
  { 61, LY({ NK(Left), CC(NextTrack), CC(NextTrack) }) },
  { 62, LY({ NK(Down), CC(VolumeUp), CC(VolumeUp) }) },
  { 63, LY({ NK(Up), CC(VolumeDown), CC(VolumeDown) }) },
  { 64, LY({ NK(Right), CC(PlayPause), CC(PlayPause) }) },
};
